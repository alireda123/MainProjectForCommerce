...
export default function Index({ openCart, setOpenCart }) {
  ...
  const [selected, setSelected] = useState('this is my default value');
      ...
      <div>
        <div className='relative'>
          ...
          <div
            ...
            } items-center justify-between bg-white py-5 px-6 dark:bg-gray-900 lg:hidden`}
          >
              ...
              <Listbox value={selected} onChange={setSelected}>
                <div className='relative mt-1'>
                  <Listbox.Button className='relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm'>
                    <span>
                      <img
                        src='https://sp.yimg.com/ib/th?id=OIP.JNCFj8JdTAvtn6X_DuBS7gHaEL&pid=Api&w=148&h=148&c=7&rs=1'
                        width='24'
                        height='24'
                      />
                    </span>
          ...
          {/* For md screen size */}
          {/* For large screens */}
          <div className='bg-gray-50 py-9  dark:bg-gray-900'>
            <div className='container mx-auto flex items-center justify-between'>
              ...
              <ul className='hidden w-7/12 items-center justify-center space-x-8 md:flex'>
                <li className='hover:animated-underline  text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 dark:text-white'>
                  <Link href='/'>Home</Link>
                </li>
                <li className='hover:animated-underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 dark:text-white '>
              ...
              <div className='flex items-center justify-end space-x-4 md:w-3/12 xl:space-x-8'>
                <div className='hidden items-center lg:flex'>
                  ...
                  <input
                    ...
                    className={` ${
                      searchInput ? 'hidden' : ''
                    } ml-1 rounded border border-transparent px-1 text-sm text-gray-600 focus:border-gray-400 focus:outline-none dark:bg-gray-900 dark:placeholder-gray-300`}
                  />
                </div>
                <div className='hidden items-center space-x-4 lg:flex xl:space-x-8'>
                  ...
                  <button
                    onClick={() => router.push('/uploadProduct')}
                    className='rounded text-black focus:outline-none  focus:ring-2 focus:ring-gray-600 dark:text-white dark:hover:text-gray-300'
                  >
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='24'
                ...
                <div className=' sm:w-18 w-72'>
                  <Listbox value={selected} onChange={setSelected}>
                    <div className='relative mt-1'>
                      <Listbox.Button className='relative flex w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 child:mx-2 sm:text-sm'>
                        <span>
                          <img
                            src='https://sp.yimg.com/ib/th?id=OIP.JNCFj8JdTAvtn6X_DuBS7gHaEL&pid=Api&w=148&h=148&c=7&rs=1'
                            width='24'
          ...
          >
            ...
            <div className='mt-6 p-4 sm:hidden'>
